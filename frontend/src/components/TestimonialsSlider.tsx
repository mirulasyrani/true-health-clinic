    ...
    <section style={{ padding: '3rem 1rem', background: '#f8fafc' }}>
      <div className="container">
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          <h2 className="section-title" style={{ fontSize: 'clamp(1.75rem, 4vw, 2.5rem)' }}>What Our Patients Say</h2>
          <p className="section-subtitle" style={{ fontSize: 'clamp(0.95rem, 2.5vw, 1.15rem)' }}>Real reviews from our valued patients</p>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '1rem', marginTop: '1rem', flexWrap: 'wrap' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              <span style={{ fontSize: 'clamp(1.25rem, 3vw, 1.5rem)', fontWeight: '700', color: '#0f172a' }}>5.0</span>
              <div>{renderStars(5)}</div>
            </div>
          </div>
        </div>

        <div style={{ maxWidth: '900px', margin: '0 auto', position: 'relative', padding: '0 0.5rem' }}>
          {/* Review Cards */}
                ...
                >
                  <div style={{
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '0.75rem', flexWrap: 'wrap' }}>
                      <div style={{ display: 'flex', gap: '0.75rem', alignItems: 'center', flex: '1 1 auto', minWidth: '0' }}>
                        <div style={{
                        ...
                        <div style={{ minWidth: '0' }}>
                          <h4 style={{ fontSize: 'clamp(1rem, 2.5vw, 1.1rem)', fontWeight: '600', color: '#0f172a', margin: 0, wordBreak: 'break-word' }}>
                            {review.author}
                          </h4>
                          <p style={{ fontSize: 'clamp(0.8rem, 2vw, 0.875rem)', color: '#64748b', margin: '0.25rem 0 0 0' }}>
                            {review.date}
                          </p>
                        </div>
                      </div>
                      <div style={{ flexShrink: 0 }}>{renderStars(review.rating)}</div>
                    </div>
                    ...
                    {/* Google Icon */}
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', paddingTop: '0.75rem', borderTop: '1px solid #e2e8f0', flexWrap: 'wrap' }}>
                      ...
                      <span style={{ fontSize: 'clamp(0.8rem, 2vw, 0.875rem)', color: '#64748b' }}>Posted on Google</span>
                    </div>
                  </div>
                </div>
              ))}
          ...
          >
            <svg width="20" height="20" viewBox="0 0 24 24" fill="#0f172a" style={{ width: 'clamp(18px, 5vw, 24px)', height: 'clamp(18px, 5vw, 24px)' }}>
