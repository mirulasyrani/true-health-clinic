  ...
  return (
    <div>
      ...
      <section className="hero">
        <HeroSlideshow slides={SLIDES} currentSlide={currentSlide} />
        ...
        <div className="hero-text-content">
          <div>
            ...
            <div className="hero-buttons">
              <a href="https://wa.me/601126133870" target="_blank" rel="noopener noreferrer" className="btn btn-primary" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', justifyContent: 'center' }}>
